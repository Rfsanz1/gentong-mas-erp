    ...
    items: [
      {
        title: 'Karyawan',
        href: '/hr/employees',
        description: 'Data dan profil seluruh karyawan',
        roles: ['admin', 'owner', 'super admin', 'hr'],
      },
      {
        title: 'Organisasi',
        href: '/hr/organization',
        description: 'Departemen, jabatan, dan struktur organisasi',
        roles: ['admin', 'owner', 'super admin', 'hr'],
      },
      {
        title: 'Kehadiran',
        href: '/hr/attendances',
        description: 'Rekap absensi bulanan seluruh karyawan',
        roles: ['admin', 'owner', 'super admin', 'hr'],
      },
      {
        title: 'Cuti & Izin',
        href: '/hr/leaves',
        description: 'Pengajuan dan persetujuan cuti karyawan',
        roles: ['admin', 'owner', 'super admin', 'hr'],
      },
      {
        title: 'Pelatihan',
        href: '/hr/training',
        description: 'Jadwal dan rekap training karyawan',
        roles: ['admin', 'owner', 'super admin', 'hr'],
      },
      {
        title: 'Pinjaman',
        href: '/hr/loans',
        description: 'Kelola pinjaman dan cicilan dari gaji',
        roles: ['admin', 'owner', 'super admin', 'hr'],
      },
      {
        title: 'BPJS',
        href: '/hr/bpjs',
        description: 'Rekap iuran BPJS Kesehatan dan Ketenagakerjaan',
        roles: ['admin', 'owner', 'super admin', 'hr'],
      },
      {
        title: 'Penilaian Kinerja',
        href: '/hr/appraisals',
        description: 'Evaluasi kinerja tahunan per karyawan',
        roles: ['admin', 'owner', 'super admin', 'hr'],
      },
      {
        title: 'Pengaturan HR',
        href: '/hr/settings',
        description: 'Konfigurasi jam kerja, cuti, dan tarif BPJS',
        roles: ['admin', 'owner', 'super admin'],
      },
    ],
  },
    ...
    items: [
      {
        ...
        href: '/hr/payrolls',
        description: 'Ringkasan status penggajian terkini',
        roles: ['admin', 'owner', 'super admin', 'hr'],
      },
      {
        title: 'Periode Penggajian',
        href: '/hr/payrolls/periods',
        description: 'Buat dan kelola periode gaji bulanan',
        roles: ['admin', 'owner', 'super admin', 'hr'],
      },
      {
        title: 'Proses Batch',
        href: '/hr/payrolls/batch',
        description: 'Hitung gaji massal satu periode',
        roles: ['admin', 'owner', 'super admin', 'hr'],
      },
      {
        title: 'Slip Gaji',
        href: '/hr/payrolls/slips',
        description: 'Lihat dan cetak slip per karyawan',
        roles: ['admin', 'owner', 'super admin', 'hr'],
      },
      {
        title: 'Komponen Gaji',
        href: '/hr/payrolls/components',
        description: 'Atur tunjangan dan potongan gaji',
        roles: ['admin', 'owner', 'super admin', 'hr'],
      },
      {
        title: 'Kalkulator BPJS',
        href: '/hr/payrolls/bpjs-calc',
        description: 'Simulasi iuran BPJS berdasarkan gaji',
        roles: ['admin', 'owner', 'super admin', 'hr'],
      },
      {
        title: 'Kalkulator PPh 21',
        href: '/hr/payrolls/pph21-calc',
        description: 'Simulasi pajak penghasilan pasal 21',
        roles: ['admin', 'owner', 'super admin', 'hr'],
      },
      {
        title: 'Riwayat Penggajian',
        href: '/hr/payrolls/history',
        description: 'Rekap pembayaran gaji per periode',
        roles: ['admin', 'owner', 'super admin', 'hr'],
      },
      {
        title: 'Export Bank',
        href: '/hr/payrolls/bank-export',
        description: 'Generate file transfer gaji ke bank',
        roles: ['admin', 'owner', 'super admin'],
      },
      {
        title: 'Laporan Payroll',
        href: '/hr/payrolls/reports',
        description: 'Rekap dan analisis penggajian per periode',
        roles: ['admin', 'owner', 'super admin', 'hr'],
      },
    ],
  },
